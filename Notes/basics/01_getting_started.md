...
> **Key insight**: Authentication determines both policy and billing. Resolve the intended account before doing substantive work, especially on a machine that has both browser credentials and cloud-provider environment variables.
