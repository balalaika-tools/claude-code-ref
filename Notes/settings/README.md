...
> Programmatic control over Claude Code's behavior — permissions, environment variables, hooks, and MCP server management.

[![Claude Code](https://img.shields.io/badge/Claude_Code-Settings-191919.svg?logo=anthropic&logoColor=white)](https://docs.anthropic.com/en/docs/claude-code)
