...
> **Key insight**: Hooks exist because CLAUDE.md instructions are advisory (Claude may or may not follow them), while hooks are deterministic harness code that runs every time an event fires, regardless of what Claude decides to do.
