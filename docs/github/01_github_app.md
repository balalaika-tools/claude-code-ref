...
> **Key insight**: `CLAUDE.md` guidance is a request Claude follows voluntarily, not an enforced constraint — anything that must always hold (permissions, blocked commands) belongs in workflow YAML, `settings.json`, or hooks instead.
