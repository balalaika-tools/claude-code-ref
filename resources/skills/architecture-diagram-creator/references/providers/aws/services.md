...
Inherited AWS4 identifier lookup snapshot. Use 48×48 non-connectable icons inside outer cards; the shared drawio-contract.md governs geometry. Verify availability in the installed renderer.
